...
T+2..T+5 -- the same WL window the array TB uses):
  ...
  70-100  quiet             leakage window 80-98 ns
...
* leakage window 80-98 ns.  See gen_dec_tb.py header for timing detail.
* ============================================================
...
%s
.measure tran p_leak_W AVG par('-v(VDD)*i(VVDD)') from=80n to=98n
