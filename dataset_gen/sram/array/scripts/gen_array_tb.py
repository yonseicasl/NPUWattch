...
Stimulus (10 ns/op cadence, identical intra-op edge timing to the column TB):
  ...
  63-150  idle               leakage window 90-149 ns (settled tail — measuring
                             earlier overstates leakage at large row counts;
                             the long 59 ns AVG window keeps pW-level leakage
                             above the transient-integrator noise floor that
                             produced negative values with the old 9 ns window)
...
which is what made large-array tr0 files hundreds of MB.  The full 0-100 ns
of the probed ports is recorded.
...
* leakage window 90-149 ns.  See gen_array_tb.py header for timing detail.
* ============================================================
