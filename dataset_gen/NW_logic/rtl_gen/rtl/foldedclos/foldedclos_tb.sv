module foldedclos_tb;
    localparam int DATA_WIDTH = 32;
    localparam int TERMINALS_PER_LEAF = 4;
    localparam int NUM_LEAVES = 4;
    localparam int NUM_SPINES = 4;
    localparam int SWITCH_RADIX = 8;
    ...
    initial begin
        ...
        if (errors == 0) begin
            ...
            $display("foldedclos_tb FAIL errors=%0d", errors);
            $fatal(1);
        end
        $finish;
    end
